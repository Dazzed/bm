...
class PrivacyPolicy extends React.Component {
    ...
    componentDidMount() {
        // { "where": { "page": "tnc" } }
        axios.get(`${API_URL}/api/staticContents/findOne?filter={ "where": { "page": "privacy" } }`).then(res => {
            ...
            <SafeAreaView style={[{ backgroundColor: this.state.colors['white'] }, styles.pageContainer]}>
                <View style={styles.menuBorder}>
                    <View style={styles.menuContainer}>
                        <TouchableOpacity style={styles.leftCta} onPress={() => this.props.hidePp()}>
                            <Image
                ...
                <View style={[{ borderTopColor: this.state.colors['borderGray'] }, styles.legalAgree]}>
                    <TouchableOpacity style={[{ backgroundColor: this.state.colors['green'] }, { borderColor: this.state.colors['green'] }, styles.fullBtn]} onPress={() => this.props.hidePp()}>
